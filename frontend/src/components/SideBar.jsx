...
const menuItemClasses = ({ isActive }) =>
  `flex items-center gap-3 px-4 py-2 rounded-md transition-all ${
    isActive
      ? "bg-[#007a6c] text-white"
      : "text-gray-200 hover:bg-[#26a699] hover:text-white"
  }`;

const SideBar = () => {

  const { t, i18n } = useTranslation(); // listen to language change
  ...
  return (
    <nav
      ...
      className="group px-2 h-full flex flex-col md:hover:w-40 md:transition-all md:duration-300"
    >
      ...
      <ul className="space-y-1">
        <li>
          <NavLink to="/" className={menuItemClasses}>
            ...
            <span className="whitespace-nowrap overflow-hidden md:w-0 md:opacity-0 md:group-hover:w-auto md:group-hover:opacity-100 md:transition-all md:duration-300">
              {t("home")}
            </span>
          </NavLink>
        </li>
        ...
        <li>
          <NavLink to="/users" className={menuItemClasses}>
            ...
            <span className="whitespace-nowrap overflow-hidden md:w-0 md:opacity-0 group-hover:w-auto group-hover:opacity-100 transition-all duration-300">
              {t("users")}
            </span>
          </NavLink>
        </li>
