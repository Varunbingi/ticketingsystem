...
import { login, clearError } from "../redux/slice/authSlice.jsx";
...
const Login = () => {
  ...
  const handleGoogle = () => {
    window.location.href =
      `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/auth/google/login`;
  };

  // GITHUB LOGIN
  const handleGithub = () => {
    window.location.href =
      `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/auth/github/login`;
  };
