    ...
    <div className="p-6 w-full space-y-6 min-h-[90vh] flex flex-col">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <Button
            text={t("add_permission_category")}
            icon={<FaPlus />}
            onClick={() => {
      ...
      {openPermissionCategory && (
        <PermissionCategoryForm
          initialData={editPermissionCategory}
          onSave={permissionCategorySave}
      ...
      <div className="bg-white rounded-xl shadow overflow-x-auto p-2">
        ...
        <table className="min-w-full border border-gray-200">
          ...
          <thead className="bg-slate-100">
            <tr>
              <th className="border border-gray-200 px-4 py-2">{t("id")}</th>
              <th className="border border-gray-200 px-4 py-2 text-start">{t("name")}</th>
              <th className="border border-gray-200 px-4 py-2 text-start">{t("description")}</th>
              <th className="border border-gray-200 px-4 py-2">{t("actions")}</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            {paginatedPermissions.map((p) => (
              <tr key={p.id} className="hover:bg-gray-50">
                ...
                <td className="text-center border border-gray-200 px-4 py-2">
                  {p.id}
                </td>
                ...
                <td className="border border-gray-200 px-4 py-2">
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <button
                      ...
                      className="bg-green-500 text-white p-1 rounded-full text-sm"
                    >
                      <MdEdit size={15} />
                    </button>
                    ...
                    <button
                      ...
                      className="bg-red-500 text-white p-1 rounded-full text-sm"
                    >
