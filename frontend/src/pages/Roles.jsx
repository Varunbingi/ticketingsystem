        ...
        <table className="min-w-full border border-gray-200">
          ...
          <thead className="bg-slate-100">
            <tr>
              ...
              <th className="text-start px-4 py-2 border border-gray-200">{t("role_name")}</th>
              <th className="text-start px-4 py-2 border border-gray-200">{t("short_name")}</th>
              <th className="text-start px-4 py-2 border border-gray-200">{t("description")}</th>
